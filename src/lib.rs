...
/// derp
pub type Vector<A> = InternalVector<Internal<A, RcK, Leaf<A>>, Leaf<A>>;

/// derp
pub type RegularVector<A> = InternalVector<Internal<A, RcK, Leaf<A>>, Leaf<A>>;
/// derp
pub type RegularFocus<'a, A> = Focus<'a, Internal<A, RcK, Leaf<A>>, Leaf<A>>;
/// derp
pub type RegularFocusMut<'a, A> = FocusMut<'a, Internal<A, RcK, Leaf<A>>, Leaf<A>>;
/// derp
pub type RegularIter<'a, A> = Iter<'a, Internal<A, RcK, Leaf<A>>, Leaf<A>>;
/// derp
pub type RegularIterMut<'a, A> = IterMut<'a, Internal<A, RcK, Leaf<A>>, Leaf<A>>;

/// derp
pub type ThreadSafeVector<A> = InternalVector<Internal<A, ArcK, Leaf<A>>, Leaf<A>>;
/// derp
pub type ThreadSafeFocus<'a, A> = Focus<'a, Internal<A, ArcK, Leaf<A>>, Leaf<A>>;
/// derp
pub type ThreadSafeFocusMut<'a, A> = FocusMut<'a, Internal<A, ArcK, Leaf<A>>, Leaf<A>>;
/// derp
pub type ThreadSafeIter<'a, A> = Iter<'a, Internal<A, ArcK, Leaf<A>>, Leaf<A>>;
/// derp
pub type ThreadSafeIterMut<'a, A> = IterMut<'a, Internal<A, ArcK, Leaf<A>>, Leaf<A>>;
